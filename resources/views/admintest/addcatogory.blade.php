...
<form  action="/addcatogory" >
                        ...
                        <div class="row row-space">
							...
							<tr>
							<td>
                                <div  class="input-group"><label style="color:black">catogory name     </label></td>
								
								<td>
                                  <input style="margin-right=200" class="input--style-4 form-control" type="text" name="catogoryname" pattern="[a-zA-Z]+$" oninput="this.reportValidity()" required="" title="Name should only contain letters.">
                                </td>
								</tr>
								</div>
                            </div>
