      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="{{ ('/listruser') }}">User</a></li>
                    ...
                    <tbody>
                                                ...
                                                <tr>
                                                     ...
                                                     <td>{{$approve->mobno}}</td>
                                                                  ...
                                                                  <td><a href="{{url('comaprove/'.$approve->id)}}">Change Status</a></td>
                                                                  <td><a href="{{url('Approvebu/'.$approve->id)}}">Delete</a></td>
                                                                 </tr>
