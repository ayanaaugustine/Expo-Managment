...
<form  action="/addsubcatogory" >
                        @csrf
                        <div class="input-group">
						<tr>
						<td>
                            <label style="color:black" class="label">catogoryname</label>
						</td>
						<td>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="catogoryname" class="input--style-4 form-control" required>
                                <option>---Select---</option>
                                   @isset($users)
                                   
                                   @foreach($users as $user)
                                   <option>{{$user->catogoryname}}</option>
                                   @endforeach
                                   @endisset
                                </select>
                        ...
                        <div class="row row-space">
							...
							<tr>
							<td>
                                <div  class="input-group"><label style="color:black">sub catogory name     </label></td>
								
								<td>
                                  <input style="margin-right=200" class="input--style-4 form-control" type="text" name="subcatogoryname" pattern="[a-zA-Z]+$" oninput="this.reportValidity()" required="" title="Name should only contain letters.">
                                </td>
								</tr>
								</div>
                            </div>
