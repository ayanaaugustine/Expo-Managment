								...
								<!--<div class="resp-tabs-container">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">	
										<div class="payment-info">
											...
											<input type="hidden" value="{{ $d }}" name="count">
											<input type="hidden" value="{{ $e }}" name="expotitle">
										
												<div class="tab-for">				
													<h5>NAME ON CARD</h5>
														<input type="text" value="" name="nameoncard" pattern="[a-zA-Z]+$" oninput="this.reportValidity()" required="" title="Name should only contain letters." >
													<h5>CARD NUMBER</h5>													
														<input class="pay-logo" type="text" maxlength="16" pattern="[0-9]{16}" required="" title=" should contain 16  letters." name="cardnumber">
												</div>	
												<div class="transaction">
													<div class="tab-form-left user-form">
														<h5>EXPIRATION</h5>
															<ul>
																<li>
																	<input type="number" class="text_box" type="text" value="6" min="1" name="date" />	
																</li>
																<li>
																	<input type="number" class="text_box" type="text" value="1988" min="1" name="dates" />	
																</li>
													...
													<div class="tab-form-right user-form-rt">
														<h5>CVV NUMBER</h5>													
														<input type="text"    required="" name="cvvno">
													</div>
													<div class="clear"></div>
												</div>
												<input type="submit" value="SUBMIT">
