			...
			<div class="wrap-login100" style="margin-top:20px;">
                    ...
                    <form method="post" action="/edit" enctype="multipart/form-data">
                        ...
                        <!--<div class="row row-space">
							...
							<td>
                                  <input class="input--style-4 form-control" type="file"  name="image" value={{$value->image}}>
							</td>
							</tr>	  
                            </div>
                            </div>
                       ...
                       <!-- <div class="row row-space">
							...
							<tr>
							<td>
                                <div class="input-group"><label style="color:white">price</label>
							</td>
							<td>
                                  <div class="input-group-icon">
                                        <input  type="number" class="form-control" name="price" required="" value={{$value->price}}>
                                        <i></i>
                                    </div>
							</td>
							</tr>
						...
						<td>
						<br>
                            <center><input  style="background:black;padding:3% 20%;border-radius:20px"  type="submit" ><label style="color:white">ADD</label></center>
                        </div>
						</td>
						</tr>
					</form>
