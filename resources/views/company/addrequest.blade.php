	...
	<div class="limiter" >
		<div class="container-login100" style="background-image: url('admin/images/bg-01.jpg');">
			<div class="wrap-login100" style="margin-top:20px;">
                    ...
                    <form method="get" action="/requestaction" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row row-space">
							...
							<tr>
							<td>
                                <div class="input-group"><label style="color:white">expotitle</label></td>
								
								<td>
                                  <input class="input--style-4 form-control" type="text" name="expotitle" pattern="[a-zA-Z]+$" oninput="this.reportValidity()" required="" title="Name should only contain letters." value="{{ $user->expotitle }}">
                                </td>
								</tr>
								</div>
                            </div>
						...
						<td>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="catogory" class="form-control" required>
						...
						<td>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="subcatogory" class="form-control" required>
                                    <option disabled="disabled" selected="selected">Choose option</option>
                        ...
                        <div class="row row-space">
							...
							<td>
                                  <div class="input-group-icon">
                                        <input  type="text" class="form-control" name="sdate" required="" value="{{ $user->sdate }}">
                                        <i></i>
                                    </div>
							</td>
							</tr>
							...
							<td>
                                  <div class="input-group-icon">
                                        <input  type="text" class="form-control" name="edate" required="" value="{{ $user->edate }}">
                                        <i></i>
                                    </div>
							</td>
							</tr>
							...
							<tr>
							<td>
                                <div class="input-group"><label style="color:white">Available booths</label></td>
								
								<td>
                                  <input class="input--style-4 form-control" type="text"  value=" {{ $user->noofbooth }}" name="noofbooth">
                                </td>
								</tr>
								</div>
                            </div>
							...
							<tr>
							<td>
                                <div class="input-group"><label style="color:white">Request for booth</label></td>
								
								<td>
                                  <input class="input--style-4 form-control" type="number" name="request" >
                                </td>
								</tr>
								</div>
                            </div>
