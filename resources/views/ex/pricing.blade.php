...
<html lang="en">
  <head>
    ...
    <title>Impression | Bootstrap HTML5 Conference and Event Template</title>
  ...
  <body>
      ...
      <div class="navigation-menu">
        <nav class="navbar navbar-default navbar-event" role="navigation" data-spy="affix" data-offset-top="20">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active animated bounceIn"><a href="pricing.html">Buy Tickets</a></li>                
          ...
          <ul class="wpb-mobile-menu">
            ...
            <li><a href="speakers.html">Speakers</a></li>                
            <li ><a href="blog.html">Blog</a></li>             
            <li class="active"><a href="pricing.html">Buy Tickets</a></li>                
            <li><a href="contact.html">Contact</a></li> 
           </ul>
          <!-- Mobile Menu End -->
    ...
    <section id="subscribe-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="content">
              <h5>Stay in touch. Subscribe to get the latest news.</h5>
    ...
    <!-- All Js plugin -->
    <script src="exhibitor/js/main.js"></script> 
    <!-- Map JS -->
