	...
	<div class="banner">
		<div class="banner-layer">
			<h1 class="title-w3layouts">
				<span class="fa fa-cart-arrow-down" aria-hidden="true"></span>VIEW TICKET</h1>
		</div>
			...
			<div class="container">
				...
				@foreach ($users as $user)
					<div class="cart-grid" style="width:auto" id="cart-1">
						...
						<form action="/bookk" method="get">
						<cemter><ul class="info">
							Name of Expo:&nbsp&nbsp<li><input type="text" name="expo" value="{{ $user->expotitle }}" readonly style="border:none"></li><br>

							Type of Expo:&nbsp&nbsp<li><input type="text" value="{{ $user->tickettype }}" readonly style="border:none"></li><br>

							Ticket rate:&nbsp&nbsp<li><input type="text" value="{{ $user->ticketrate }}" readonly style="border:none"></li><br>

							number of tickets:&nbsp&nbsp<li><input type="text" value="{{ $user->nooftickets }}" readonly style="border:none"></li><br>
                        ...
                        <!-- @method('DELETE') -->
								<button type="submit" class="button w3l-cart" data-id="cart-1">BOOK NOW</button>
							</form>
						</div>
						<br>
						<br>
